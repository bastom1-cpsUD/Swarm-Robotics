...
tasks.register<JavaExec>("runGraph") {
    group = "application"
    description = "Run the Graph application"
    mainClass.set("org.Graphs.Graph")
    classpath = sourceSets["main"].runtimeClasspath
}

tasks.register<JavaExec>("runTransformations") {
    group = "application"
    description = "Run the Transformations application"
